...
const Seriessing = ({responses, country, genre, video, reviews, similar, company, prev, next, fetchsingleseries}) => {
          ...
          <div className="container">
            <div className="row">
              <div className="col-12">
                <h1 className="details__title">{responses.original_name}</h1>
              </div>
                    ...
                    <table className="accordion__list">
                      <thead>
                        <tr>
                          <th>{prev.air_date}</th>
                          <th>{prev.name}</th>
                          <th>Episode {prev.episode_number}</th>
                        </tr>
                      </thead>
                    </table>
                  </div>
                    ...
                    <table className="accordion__list">
                      <thead>
                        <tr>
                          {/* <th>{next.air_date}</th> */}
                          {/* <th>{next.name}</th>
                          <th>Episode {next.episode_number}</th> */}
                        </tr>
                      </thead>
                    </table>
                  </div>
              ...
              <div className="col-12 col-lg-4 col-xl-4">
                <div className="row row--grid">
                  ...
                  {similar.slice(0,6).map((item)=>(
                    <Link to='/singleseries' className="col-6 col-sm-4 col-lg-6">
                      <div className="card">
                        <a className="card__cover" onClick={()=>fetchsingleseries(item)}>
